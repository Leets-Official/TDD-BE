...
public enum PartyErrorCode implements ErrorCode {
    ...
    CLOSE_MIN_PARTICIPANTS(HttpStatus.BAD_REQUEST, "최소 모집 인원 이상일 때만 모집을 마감할 수 있습니다."),
    ...
    SETTLEMENT_FORBIDDEN(HttpStatus.FORBIDDEN, "정산 완료를 처리할 권한이 없습니다."),
    SETTLEMENT_NOT_DELIVERED(HttpStatus.BAD_REQUEST, "배달 도착 상태인 배달팟만 정산 완료할 수 있습니다."),
    ALREADY_SETTLED(HttpStatus.BAD_REQUEST, "이미 정산이 완료된 배달팟입니다.");
