...
public class DeliveryPartyDetailResponse {
    ...
    public DeliveryPartyDetailResponse(DeliveryParty deliveryParty, User leader, Dormitory dormitory) {
        ...
        this.dormitory = dormitory != null ? dormitory.getDormitory() : null;
